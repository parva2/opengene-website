...
export default function AboutPage() {
  return (
    <section className="p-8 max-w-5xl mx-auto">
      <h1 className="text-4xl font-bold mb-6 text-center">OpenGene: Igniting the Genetic Revolution</h1>
      ...
      <div className="mb-12">
        ...
        <p className="text-lg text-gray-700">
          At the heart of our platform lies a state-of-the-art blockchain-based system designed to ensure robust data security and transparency. We leverage:
        </p>
        <ul className="list-disc list-inside text-lg text-gray-700 mb-4">
          <li>AES-256 encryption for advanced data protection.</li>
          <li>IPFS for decentralized storage.</li>
          <li>Decentralized Identity (DID) solutions that guarantee users complete control over their digital identities.</li>
        </ul>
        <p className="text-lg text-gray-700">
      ...
      <div className="mb-12">
        ...
        <div className="text-lg text-gray-700 mb-4">
          <h3 className="text-2xl font-semibold mb-2">For Academic Institutions:</h3>
          <p>
